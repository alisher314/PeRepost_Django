...
SECRET_KEY = 'django-insecure-o+&q(nj9cw8ipjbd#pg7gj=-r*!qv0$*bh36mijrmu#kj#fmrp'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'perepost_db',        # имя базы
        'USER': 'pereuser',           # имя пользователя
        'PASSWORD': 'GoodOldArsenal31',   # пароль, который ты задал
